...
//               <div className="bg-[#FF0000] text-white w-6 h-6 rounded-full flex items-center justify-center">
//                 ?
//               </div>
//             </div>
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-2/3 md:mr-6">
          ...
          <div className="space-y-8">
            <div className="bg-white p-4 shadow-lg  relative">
              ...
              <p className="text-gray-600 mb-4">
                ...
                Aliquam laoreet purus in iaculis sodales. Morbi convallis diam
                ac accumsan placerat. Donec ultrices placerat arcu non accumsan
              </p>
            </div>
            <div className="flex justify-end space-x-4 text-sm text-gray-500">
              <span>Was this answer helpful?</span>
              <span className="cursor-pointer hover:text-[#FF0000]">Yes</span>
              <span className="cursor-pointer hover:text-[#FF0000]">No</span>
            </div>
            ...
            <div className="bg-white p-4 shadow-lg  relative">
              ...
              <p className="text-gray-600 mb-4">
                Sed vel erat mi. Donec hendrerit consectetur ipsum, ut lacinia
                sem egestas sed. Praesent ac augue dolor. Proin euismod nulla
                vel ipsum cursus, nec sagittis risus volutpat. Phasellus eu quam
                metus. Ut luctus ut nulla vel blandit. Quisque accumsan mauris
                non rutrum fermentum. Phasellus non ornare ligula. Duis maximus
                vitae est ullamcorper condimentum. Sed consequat pulvinar
                turpis, sed condimentum nibh pretium in.
              </p>
            </div>
            <div className="flex justify-end space-x-4 text-sm text-gray-500">
              <span>Was this answer helpful?</span>
          ...
          <div className="flex justify-center mt-8">
            ...
            <Link href={"#"}>
              <button
                className={`mx-2 px-5 py-2 rounded-md bg-[#FF0000] text-white hover:bg-white hover:text-black bg-opacity-80 hover:transition hover:duration-600`}
              >
                1
              </button>
            </Link>
