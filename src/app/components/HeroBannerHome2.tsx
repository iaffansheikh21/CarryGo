...
const HeroBannerHome3 = () => {
  return (
    <>
      <div className="relative url(/hero-background-icons.jpg)  flex items-center justify-center  h-full  ">
        <div className="lg:pt-20  pl-1 pr-4 h-full lg:pr-0   lg:w-[80%] w-[85%]">
          <h1
            className={`text-center  text-3xl md:text-4xl font-light mb-6 mt-12 sm:mt-16 md:mt-0`}
          >
            <Link
              href="#"
              className="inline-block text-white hover:underline underline  hover:text-[#FF0000] hover:transition hover:duration-700"
            >
              Buy
            </Link>
            ...
            <Link
              href="#"
              className="inline-block underline text-white hover:underline hover:text-[#FF0000] hover:transition hover:duration-700"
            >
              Sell
            </Link>
            <span className="mx-1 text-white sm:mx-2">or</span>
            <Link
              href="#"
            ...
            <span className="mx-1 text-white sm:mx-2">What You Need</span>
          </h1>
...
export default HeroBannerHome3;
