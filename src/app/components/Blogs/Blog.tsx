  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row justify-center min-h-screen bg-[#F2F2F2] p-4 lg:p-8">
        ...
        <div className="max-w-4xl w-full">
            ...
            <div className="relative">
              ...
              <div className="p-4">
                ...
                <div className="flex space-x-2 mb-2">
                  <Link href={"#"}>
                    <span className="bg-white hover:text-red-500 border text-gray-700 text-sm px-2 py-1 rounded">
                      Blog & Decor
                    </span>
                  </Link>
                  <Link href={"#"}>
                ...
                <p className="text-gray-500">
                  ...
                  sollicitudin dapibus, risus mi euismod elit
                </p>
          ...
          <div className="bg-white shadow-md mt-8 rounded-lg overflow-hidden">
            <div className="relative">
              ...
              <div className="p-4">
                <h1 className="text-2xl font-normal mb-2">
                  8 Things to Remember Every Morning
                </h1>
                <div className="flex space-x-2 mb-2">
                  <Link href={"#"}>
                    <span className="bg-white hover:text-red-500 border text-gray-700 text-sm px-2 py-1 rounded">
          ...
          <div className="bg-white shadow-md mt-8 rounded-lg overflow-hidden">
            <div className="relative">
              ...
              <div className="p-4">
                <h1 className="text-2xl font-normal mb-2">
                  Professional kitchen at your home
                </h1>
                <div className="flex space-x-2 mb-2">
                  <Link href={"#"}>
                    <span className="bg-white hover:text-red-500 border text-gray-700 text-sm px-2 py-1 rounded">
                ...
                <button className="mt-4 px-4 py-2 bg-white text-[#FF0000] border border-[#FF0000] rounded hover:bg-[#FF0000] hover:text-white transition duration-700">
                  Read more
                </button>
              </div>
            </div>
        ...
        {/* Sidebar */}
        <div className="max-w-xs w-full h-full lg:ml-8 mt-8 lg:mt-0   rounded-lg p-4">
