...
const Blog = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-center min-h-screen bg-[#F2F2F2] p-4 lg:p-8">
          ...
          <div className="relative">
            ...
            <div className=" ">
              <div className="p-4 bg-[#F2F2F2] ">
                ...
                <div className="flex space-x-2 mb-2">
                  <Link href="#">
                    <span className=" hover:text-[#FF0000] border text-gray-700 text-sm px-2 py-1 rounded">
                      Blog & Decor
                    </span>
                  </Link>
                  <Link href="#">
              ...
              <div className="flex items-center text-gray-600 text-xs font-bold p-4 mb-2 mt-4">
                <Link href="#">
                  <span className="flex items-center mr-2 hover:text-[#FF0000]">
                    <FaUser className="mr-1 mb-1 text-[#FF0000]" /> John Doe
                  </span>
                </Link>
              ...
              <p className="text-gray-400 text-md p-4">
              ...
              <h1 className="text-2xl font-normal p-4 mb-8 mt-9">
                10 tips for renovation
              </h1>
              <p className="text-gray-400 p-4 text-md">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut nec
                tincidunt arcu, sit amet fermentum sem. Class aptent taciti
                sociosqu ad litora torquent per conubia nostra, per inceptos
                himenaeos. Lorem ipsum dolor sit amet, consectetur adipiscing
                elit. Ut nec tincidunt arcu, sit amet fermentum sem. Class
                aptent taciti sociosqu ad litora torquent per conubia nostra,
                per inceptos himenaeos. Lorem ipsum dolor sit amet, consectetur
                adipiscing elit. Ut nec tincidunt arcu, sit amet fermentum sem.
      ...
      {/* Sidebar */}
      <div className="max-w-xs w-full h-full lg:ml-8 mt-8 lg:mt-0    p-4">
        <h2 className="text-xl font-normal mb-4 mt-2">Search Blog</h2>
        <input
          type="text"
          placeholder="Enter keyword and press enter"
        ...
        <div className="space-y-4">
          {[
            "How to build a cool swimming pool",
            "Concrete decorations can be beautiful",
            "Let's take a break",
          ].map((post) => (
            <div key={post} className="flex items-center space-x-4">
              <div className="w-20 h-16 bg-gray-200 rounded-lg"></div>
          ...
          <br />
          <br />
          <h2 className="text-xl font-normal mt-6 ">Popular Posts</h2>
