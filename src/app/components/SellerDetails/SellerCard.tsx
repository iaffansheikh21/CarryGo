    ...
    <>
      ...
      >
        ...
        <div
          className={`grid ${
            layout === "vertical"
              ? "grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-8 w-[65%] h-full overflow-hidden"
            ...
            >
              <div className="m-2 overflow-hidden">
                <div className="relative">
                  ...
                  {card.categoryLabel && (
                    <div className="absolute top-1/2 left-3 mt-6 mb-2  transform -translate-y-1/2 bg-black font-bold text-white cursor-pointer text-xs px-2 py-1 hover:bg-red-700">
                      {card.categoryLabel}
                    </div>
                  )}
                  {layout === "vertical" && (
                    <>
                      <div className="absolute top-32 left-3 mt- text-lg font-semibold whitespace-nowrap hover:underline text-white cursor-pointer">
                        {card.title}
                      </div>
                      <div className="absolute top-44 pt-4 left-3 flex items-center text-md font-sans font-bold text-[#878689]">
                      ...
                      <div className="text-md flex flex-col md:flex-row text-[#878689] pt-2 ">
                        <div className="flex items-center text-sm text-[#878689]">
                          <SlCalender className="mr-1" />
                          {card.date}
                        </div>
                        <div className="flex items-center mt-1 mb-1 ml-5">
                ...
                <div className="flex flex-col justify-between w-full p-2">
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-gray-900 pl-3 p-4">
                        {card.description}
                      </div>
              ...
              {layout === "vertical" && (
                <div className="bg-white rounded-b-lg pt-2 h-40 flex flex-col justify-between">
