...
const CardComponent = () => {
  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row items-center lg:items-start lg:mx-24">
        <div
          className={`flex flex-col items-center ${
            layout === "horizontal" ? "space-y-0" : "space-y-2"
          } `}
        >
          <div className="flex justify-between items-start mb-6 w-full lg:w-[86%] lg:ml-20 z-50">
          ...
          <div
            className={`grid ${
              layout === "vertical"
                ? "grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full lg:w-[86%] lg:ml-20 h-full overflow-hidden"
                : "grid-cols-1 gap-7 w-[89%] lg:ml-20"
            }`}
          >
