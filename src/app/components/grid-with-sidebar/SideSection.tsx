    ...
    <>
      <div className="grid grid-cols-1 gap-4 mb-4 w-full">
        <div className="grid grid-cols-1 gap-4">
          <div>
            <label className="block text-red-600 text-lg mb-2" htmlFor="what">
              What?
            </label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-red-600 text-lg mb-2" htmlFor="where">
              Where?
            </label>
          ...
          <div>
            <label
              className="block text-red-600 text-lg mb-2"
              htmlFor="category"
            >
              Category?
            </label>
      ...
      <div className="flex items-center justify-start mb-4">
        ...
        >
          <span className="text-lg mr-2">+</span> More Options
        </button>
      </div>
