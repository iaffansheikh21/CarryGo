...
const AdForm = () => {
  ...
  return (
    <div className="lg:w-[90%] w-full  mx-auto p-6 overflow-hidden bg-[#F2F2F2]">
      <div className="bg-yellow-50 p-4 rounded mb-6 mt-6">
        <p>You don&apos;t have an account!</p>
        <p className="text-sm">
          You can submit only 1 ad at a time. To submit more, you need to{" "}
      ...
      <div className="bg-[#F2F2F2] rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            ...
            {errors.typeInput && (
              <p className="text-red-600 text-sm">{errors.typeInput}</p>
            )}
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 mt-6">
          <div>
            ...
            />
            {errors.titleInput && (
              <p className="text-red-600 text-sm">{errors.titleInput}</p>
            )}
          </div>
          <div>
            ...
            />
            {errors.priceInput && (
              <p className="text-red-600 text-sm">{errors.priceInput}</p>
            )}
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div>
            ...
            />
            {errors.nameInput && (
              <p className="text-red-600 text-sm">{errors.nameInput}</p>
            )}
          </div>
          <div>
            ...
            />
            {errors.emailInput && (
              <p className="text-red-600 text-sm">{errors.emailInput}</p>
            )}
          </div>
          <div>
            ...
            />
            {errors.phoneInput && (
              <p className="text-red-600 text-sm">{errors.phoneInput}</p>
            )}
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          <textarea
            placeholder="Details"
            className="w-full p-2 border rounded h-24 mb-10"
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <div>
            ...
            />
            {errors.cityInput && (
              <p className="text-red-600 text-sm">{errors.cityInput}</p>
            )}
          </div>
          <div>
            ...
            <input
              ...
              className="w-full p-2 border rounded"
            />
            {errors.districtInput && (
              <p className="text-red-600 text-sm">{errors.districtInput}</p>
            )}
          </div>
          <div>
        ...
        <div
          {...getRootProps()}
          className={`border-dashed border-2 border-gray-300 p-6 text-center mb-8 hover:bg-gray-200 cursor-pointer ${
            isDragActive ? "border-red-500" : ""
          }`}
        >
          <input {...getInputProps()} />
          <p className="text-gray-500">
            <span className="text-red-500">+</span> Click or drag images here
          </p>
        </div>
        ...
        <div className="mt-4 flex justify-end">
          <button
            ...
            className="bg-[#FF0000] flex flex-wrap text-xl  ease-in-out transition duration-400 text-white p-4 rounded"
          >
            Preview <IoIosArrowForward className="ml-2 mt-1 font-bold" />
          </button>
        </div>
      </div>
    </div>
