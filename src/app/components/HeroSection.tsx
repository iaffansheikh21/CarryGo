...
import HeroBannerHome3 from "./HeroBannerHome2";
...
export default function Home() {
  ...
  const getBackgroundImage = () => {
    if (pathname === "/home2") {
      return "url(/hero-background-image-01.jpg) object";
    } else if (pathname === "/home3") {
    ...
    <>
      <div
        style={{
          ...
          position: "relative",
          height: pathname === "/home3" ? "auto" : "", // Adjust height based on the route
          width: "100%",
          overflow: "hidden",
        }}
      >
        {pathname === "/home3" ? (
          ...
          <div
            className="relative  lg:h-[60vh] h-[98%]"
            style={{
              backgroundImage: "url(/hero-background-image-01.jpg)",
              backgroundSize: "cover",
              backgroundPosition: "center",
          ...
          // <div className="relative z-20 flex items-center justify-center h-full mt-4 ">
          //   <div className="p-5 lg:w-[80%] w-full">
          //     <h1
          ...
          //           <label
          //             className={`block text-[#FF0000] text-xl mb-2 ${getTextColorClass()}`}
          //             htmlFor="what"
          //           >
          ...
          //       </div>
          //       <div className="flex items-end md:col-span-1  ">
          //         <button className="bg-[#FF0000] mt- text-white  px-6 py-2  hover:shadow-xl hover:transition hover:duration-500 ease-in-out text-md rounded font-semibold w-full">
          //           Search
          //         </button>
          //       </div>
          //     </div>
        ...
        {/* <div className="lg:hidden md:block block mb-10">
          <MoreOptions />
        </div> */}
      </div>
